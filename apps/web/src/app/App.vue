  ...
  <div class="app-shell">
    <header class="site-header">
      ...
      <nav aria-label="Main navigation">
        ...
        ><RouterLink to="/webmcp">WebMCP</RouterLink
        ><RouterLink to="/hackathon">Hackathon</RouterLink><RouterLink to="/evals">Evals</RouterLink
    ...
    <main><RouterView :key="lens.session.id" /></main>
    <SetupDialog :key="lens.session.id" />
